...
class DashboardNode(Node):
    ...
    def __init__(self, signals: DashboardSignals):
        ...
        # Subscriber para estado da máquina de estados de missão
        self.mission_subscriber = DashboardMissionSubscriber(self, self.signals.mission)
        ...
        # Publisher para comandos de missão para o Mission Node
        self.mission_publisher = DashboardMissionPublisher(self)
        ...
        self.signals.configure_publishers(self.mission_publisher, self.cv_publisher)
