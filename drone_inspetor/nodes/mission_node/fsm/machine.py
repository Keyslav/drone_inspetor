...
from drone_inspetor.common.enums import DroneStateDescription, MissionStateDescription
from drone_inspetor.nodes.mission_node.fsm.context import MissionFSMContext


class MissionFSMachine(StateMachine):
    ...
    def tick(self) -> None:
        ...
        if self._current_state_id != MissionStateDescription.DESATIVADO:
            if drone_state == DroneStateDescription.OFFBOARD_DESATIVADO:
                ...
                self.context.reset()
                self.transition_to(MissionStateDescription.DESATIVADO)
                return
        ...
        if self.context.cancel_mission:
            ...
            self.transition_to(MissionStateDescription.RETORNANDO)
            return
    ...
    def register_all_states(self):
        ...
        from drone_inspetor.nodes.mission_node.fsm.states.desativado import DesativadoState
        from drone_inspetor.nodes.mission_node.fsm.states.pronto import ProntoState
        from drone_inspetor.nodes.mission_node.fsm.states.executando_armando import ExecutandoArmandoState
        from drone_inspetor.nodes.mission_node.fsm.states.executando_decolando import ExecutandoDecolandoState
        from drone_inspetor.nodes.mission_node.fsm.states.executando_inspecionando import ExecutandoInspecionandoState
        from drone_inspetor.nodes.mission_node.fsm.states.executando_inspecionando_detectando import ExecutandoDetectandoState
        from drone_inspetor.nodes.mission_node.fsm.states.executando_inspecionando_escaneando import ExecutandoEscaneandoState
        from drone_inspetor.nodes.mission_node.fsm.states.executando_inspecionando_escaneamento_finalizado import ExecutandoEscaneamentoFinalizadoState
        from drone_inspetor.nodes.mission_node.fsm.states.executando_inspecionando_falha import ExecutandoFalhaState
        from drone_inspetor.nodes.mission_node.fsm.states.inspecao_finalizada import InspecaoFinalizadaState
        from drone_inspetor.nodes.mission_node.fsm.states.retornando import RetornandoState

        DS = MissionStateDescription
